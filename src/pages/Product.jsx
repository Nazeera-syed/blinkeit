    ...
    <section className=''>
      ...
      <div className='p-4 bg-blue-50'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4'>
            {
              productData.map((p, index) => {
                return (
                  <ProductCard data={p} fetchProductData={fetchProductData} />
                )
              })
            }
          </div>
        ...
        <div className='flex justify-between my-4'>
          <button onClick={handlePrev} className="border border-primary-200 px-4 py-1 hover:bg-primary-200">prev</button>
